...
```
cd existing_repo
git remote add origin https://gitlab.rz.uni-bamberg.de/dsg/dsam/group7.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.rz.uni-bamberg.de/dsg/dsam/group7/-/settings/integrations)
